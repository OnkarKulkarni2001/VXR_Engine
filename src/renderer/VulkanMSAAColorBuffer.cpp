...
VulkanMSAAColorBuffer::VulkanMSAAColorBuffer(VulkanDevice* device, VkFormat colorFormat, VkExtent2D extent)
    : m_Device(device), m_Format(colorFormat), m_Extent(extent)
{
    ...
    {
        LOG_ERROR("Failed to allocate MSAA color image memory!");
        return;
    }
